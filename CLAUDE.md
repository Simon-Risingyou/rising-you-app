...
**Statistieken (admin)**: `fn_statistieken()→jsonb` — anonieme, gegroepeerde aantallen (leeftijd-emmer, postcode, herkomst, deelnames per activiteit). Nooit individuele leden identificeerbaar.
